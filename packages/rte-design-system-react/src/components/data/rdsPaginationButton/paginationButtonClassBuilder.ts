...
export const PAGINATION_COMMON_NUMBER_CLASSES = 'rds-flex rds-items-center rds-justify-center';

export const PAGINATION_NUMBER_CLASSES = {
...
export const paginationButtonClassBuilder = (active: boolean): { buttonClasses: string; numberClasses: string } => ({
  buttonClasses: PAGINATION_BUTTON_CLASSES,
  numberClasses: clsx(
    PAGINATION_COMMON_NUMBER_CLASSES,
    active ? PAGINATION_NUMBER_CLASSES.active : PAGINATION_NUMBER_CLASSES.default,
  ),
});
