...
import { ChipStatus } from './StdChipToggle';
...
const paddingChip = (label?: string, icon?: StdIconId): string => {
...
export const chipClassBuilder = (status: ChipStatus, label?: string, icon?: StdIconId) => ({
  chipClasses: clsx(
    COMMON_CLASSES,
