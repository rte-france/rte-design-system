...
import { dateInputClassBuilder } from './dateInputClassBuilder';
import './stdInputDate.css';
...
const StdInputDate = ({
  ...
  const id = useStdId('input-date', propsId);
  ...
  return (
    <div className="group inline-flex w-full flex-col items-start justify-start" onBlur={handleBlur}>
      ...
      <div className={divInputsClasses} id={id}>
        {(inputDateType === 'dateOnly' || inputDateType === 'dateAndTime') && (
          <>
            <StdIcon name={StdIconId.CalendarMonth} color="gray-500" />
            <input
              ref={inputDateRef}
        ...
        {(inputDateType === 'timeOnly' || inputDateType === 'dateAndTime') && (
          <>
            <StdIcon name={StdIconId.Schedule} color="gray-500" />
            <input
              ref={inputTimeRef}
              className={inputClasses}
              type="time"
        ...
        {showClearButton && (
          <StdButton variant="transparent" icon={StdIconId.Close} onClick={handleClear} size="extraSmall" />
        )}
      </div>
