...
import StdFileInput from "../StdFileInput";
import { vitest } from "vitest";

const TEST_ID = "Id";
const TEST_LABEL = "Label";
const TEST_SECOND_LABEL = "Second label";
const TEST_FILE = new File(["file content"], "filename.txt", {
  type: "text/plain",
});
...
describe("StdFileInput", () => {
  it("renders the default StdFileInput component with the proper values", () => {
