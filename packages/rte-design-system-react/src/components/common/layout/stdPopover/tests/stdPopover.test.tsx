...
import {
  ELEMENT_PREFIX_ID,
  TRIGGER_PREFIX_ID,
} from "../../stdFloatingWrapper/StdFloatingWrapper";
...
describe("StdPopover", () => {
  it("renders the StdPopover with Trigger and Content", () => {
    ...
    expect(document.querySelector(triggerId)).toBeDefined();
    expect(document.querySelector(triggerId)).toContain("trigger");
    expect(document.querySelector(contentId)).toBeDefined();
    expect(document.querySelector(contentId)).toContain("content");
  });
