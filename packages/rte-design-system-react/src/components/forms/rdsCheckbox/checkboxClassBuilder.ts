...
export const COMMON_CHECKBOX_CLASSES =
  'rds-box-content rds-h-1.5 rds-w-1.5 rds-flex rds-justify-center rds-items-center rds-rounded-sm rds-border peer-[:rds-not( peer-indeterminate:rds-[&_.indeterminate-icon] peer-focus-visible:rds-outline rds-outline-offset-1 rds-outline-1';
...
export const OTHER_CHECKBOX_CLASSES = {
  ...
  disabled: clsx('rds-border-gray-500 rds-bg-gray-200 rds-text-gray-500 rds-cursor-not-allowed', DISABLED_CLASSES),
};
export const ERROR_CLASSES =
  '[&]:rds-border-error-600 peer-checked:[&]:rds-border-error-600 rds-outline-1 rds-outline-offset-0 rds-outline-error-600';
export const COMMON_LABEL_CLASSES = 'rds-text-body-s rds-select-none';
...
export const ERROR_LABEL_TEXT_CLASS = 'rds-text-error-600';
