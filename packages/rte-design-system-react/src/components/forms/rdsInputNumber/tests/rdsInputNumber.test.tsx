...
import { RdsInputNumber } from '../RdsInputNumber.tsx';
...
describe('RdsInputNumber', () => {
  it('renders the default RdsInputNumber component', () => {
...
describe('getInputNumberValue function', () => {
  ...
  it('should return input value when inputRef has a valid numeric value', () => {
    const defaultValue = 10;
    const inputValue = 20;
    const inputRef = { current: { valueAsNumber: inputValue } } as RefObject<HTMLInputElement>;
    const result = getInputNumberValue(inputRef, defaultValue);
  ...
  it('should return default value when inputRef has an invalid value', () => {
    const defaultValue = 10;
    const inputRef = { current: { valueAsNumber: 'invalid' } } as unknown as RefObject<HTMLInputElement>;
    const result = getInputNumberValue(inputRef, defaultValue);
    expect(result).toEqual(defaultValue);
  });
});
