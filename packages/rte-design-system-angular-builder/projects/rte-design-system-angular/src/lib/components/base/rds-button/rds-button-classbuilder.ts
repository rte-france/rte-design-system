...
export const FOCUS_CLASSES = {
  primary: buildTailwindClasses('outline', { focus: [EMPTY_SUFFIX, '-1', 'offset-2', 'primary-900'] }),
  secondary: buildTailwindClasses('outline', { focus: [EMPTY_SUFFIX, '-1', 'offset-2', 'gray-900'] }),
  danger: buildTailwindClasses('outline', { focus: [EMPTY_SUFFIX, '-1', 'offset-2', 'gray-900'] }),
};
...
export const VARIANT_CLASSES = {
  ...
  secondary: {
    contained: [
      buildTailwindClasses('bg', { [EMPTY_PREFIX]: ['gray-200'], hover: ['gray-300'], active: ['gray-400'] }),
      buildTailwindClasses('border', { [EMPTY_PREFIX]: [EMPTY_SUFFIX, 'gray-200', 'opacity-0'] }),
    ],
    //add rds-bg-gray-200 | hover:rds-bg-gray-300 | active:rds-bg-gray-400 | rds-border-gray-200
    outlined: [
      buildTailwindClasses('bg', { [EMPTY_PREFIX]: ['gray-w'], hover: ['gray-50'], active: ['gray-100'] }),
      buildTailwindClasses('border', { [EMPTY_PREFIX]: [EMPTY_SUFFIX, 'gray-600'] }),
      buildTailwindClasses('text', { [EMPTY_PREFIX]: ['gray-600'] }),
    ],
    //add rds-bg-gray-w | hover:rds-bg-gray-50 | active:rds-bg-gray-100 | rds-border-gray-600 | rds-text-gray-600
    dashed: [
      buildTailwindClasses('bg', { [EMPTY_PREFIX]: ['transparent'], hover: ['gray-50'], active: ['gray-100'] }),
      buildTailwindClasses('border', { [EMPTY_PREFIX]: [EMPTY_SUFFIX, 'dashed', 'gray-600'] }),
      buildTailwindClasses('text', { [EMPTY_PREFIX]: ['gray-600'] }),
    ],
    //add rds-bg-transparent | rds-border-dashed
    text: [
    ...
    transparent: [
      buildTailwindClasses('bg', { [EMPTY_PREFIX]: ['transparent'] }),
      buildTailwindClasses('border', { [EMPTY_PREFIX]: [EMPTY_SUFFIX, 'transparent'] }),
      buildTailwindClasses('text', { [EMPTY_PREFIX]: ['gray-900'], hover: ['gray-700'], active: ['gray-600'] }),
    ],
  ...
  danger: {
    ...
    dashed: [
      buildTailwindClasses('bg', { [EMPTY_PREFIX]: ['gray-w'], hover: ['error-50'], active: ['error-100'] }),
      buildTailwindClasses('border', { [EMPTY_PREFIX]: [EMPTY_SUFFIX, 'dashed', 'error-700'] }),
      buildTailwindClasses('text', { [EMPTY_PREFIX]: ['error-700'] }),
    ],
    text: [
      buildTailwindClasses('bg', { [EMPTY_PREFIX]: ['transparent'], hover: ['error-50'], active: ['error-100'] }),
      buildTailwindClasses('border', { [EMPTY_PREFIX]: [EMPTY_SUFFIX, 'opacity-0', 'error-700'] }),
      buildTailwindClasses('text', { [EMPTY_PREFIX]: ['error-700'] }),
    ],
    transparent: [
      buildTailwindClasses('bg', { [EMPTY_PREFIX]: ['transparent'], hover: ['gray-700'], active: ['gray-600'] }),
      buildTailwindClasses('border', { [EMPTY_PREFIX]: [EMPTY_SUFFIX, 'transparent'] }),
      buildTailwindClasses('text', { [EMPTY_PREFIX]: ['gray-900'] }),
    ],
  },
};
